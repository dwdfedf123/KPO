# 🧩 Интеграционные тесты для проекта по KPO
...
В терминале из корня проекта (репозиторий: https://github.com/dwdfedf123/KPO): 
...
```
## 📝 Примечания
1. Тесты используют реальную базу данных 
